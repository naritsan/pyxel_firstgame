...
class App:
    def __init__(self):
        ...
        self.line1 = Segment(Vector2(50,80),Vector2(50,-10))
    ...
    def update(self):
        ...
        # 直線上の一点からマウス位置までの線分
        self.line2p = Segment(self.p1,Vector2(self.p1.x - self.line1.p.x,self.p1.y - self.line1.p.y))
        ...
        # 線分とベクトルの向き
        self.isOverlapped:bool = math.fabs(self.dot - self.mags_mul) < 1

        self.isHit:bool = self.isOverlapped and self.line2p.v.magnitude() < self.line1.v.magnitude()
